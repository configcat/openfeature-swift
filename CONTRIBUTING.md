# Contributing to the ConfigCat OpenFeature Provider for Swift
...
The ConfigCat SDK team monitors the [issue tracker](https://github.com/configcat/openfeature-swift/issues) in the Provider repository. Bug reports and feature requests specific to this SDK should be filed in this issue tracker. The team will respond to all newly filed issues.
...
### Xcode
Open the project in Xcode and execute the tests by `Product` -> `Test`.
